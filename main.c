...
/* tmp */
static void print_bg_palette_table(uint8_t *table);
...
int main(void)
{
    ...
    printf("--------------------------------\n");
    print_bg_palette_table(bg_palette_table);
    printf("--------------------------------\n");
    if (0)
...
const uint8_t *get_bg_palette(int attr)
{
    return bg_palette_table + attr * 4;
}

const uint8_t *get_color(int index)
{
